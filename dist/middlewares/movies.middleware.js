...
import { validateGenrePayload, validateGenreUploadPayload, validateMoviesSchema, } from '../validations/movies.validation.js';
...
export const genresUpdateMiddleware = async (req, res, next) => {
